      ...
      <div className="mx-auto grid w-full max-w-[1280px] gap-10 px-[5%] py-14 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href={trackServicesContact.social.instagram} target="_blank" rel="noopener noreferrer" className="transition hover:text-[#E8621A]">Instagram</a></li>
            <li><a href={trackServicesContact.social.linkedin} target="_blank" rel="noopener noreferrer" className="transition hover:text-[#E8621A]">LinkedIn</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href={trackServicesContact.generalPhone.href} className="transition hover:text-[#E8621A]">{trackServicesContact.generalPhone.display}</a></li>
            <li><a href={trackServicesContact.commercialWhatsApp.href} target="_blank" rel="noopener noreferrer" className="transition hover:text-[#E8621A]">{trackServicesContact.commercialWhatsApp.display}</a></li>
            <li><a href={`mailto:${trackServicesContact.email}`} className="transition hover:text-[#E8621A]">{trackServicesContact.email}</a></li>
            <li><a href="#portal" className="transition hover:text-[#E8621A]">Acessar portal</a></li>
            <li><a href={trackServicesContact.careersWhatsApp.href} target="_blank" rel="noopener noreferrer" className="transition hover:text-[#E8621A]">Seja um instalador</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 px-[5%] py-5">
        <div className="mx-auto flex w-full max-w-[1280px] flex-wrap items-center justify-between gap-3 text-xs text-slate-500">
          ...
          <div className="flex gap-5">
            <a href="/politica-de-privacidade" className="transition hover:text-[#E8621A]">Política de Privacidade</a>
            <a href="/termos-de-uso" className="transition hover:text-[#E8621A]">Termos de Uso</a>
            <a href="/lgpd" className="transition hover:text-[#E8621A]">LGPD</a>
          </div>
        </div>
      </div>
    </footer>
