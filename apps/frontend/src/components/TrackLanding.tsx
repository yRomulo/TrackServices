  ...
  return (
    <>
      ...
      <main>
        ...
        <a href="https://api.whatsapp.com/send?phone=5522992264840" target="_blank" rel="noopener noreferrer" title="WhatsApp" className="fixed bottom-6 right-6 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-[#25D366]/50 transition hover:scale-105">
